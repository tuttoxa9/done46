...
// Используя import вместо direct src позволяет Vite включить эти ресурсы в сборку заранее
...
// Импортируем иконки в качестве модулей, чтобы гарантировать их загрузку при инициализации
const storeIcons = {
                      ...
                      <div className="space-y-4">
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <img src={storeIcons.googlePlay} alt="Google Play" width="28" height="28" loading="eager" />
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <img src={storeIcons.appStore} alt="App Store" width="28" height="28" loading="eager" />
                            <div className="text-left">
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <img src={storeIcons.appGallery} alt="AppGallery" width="28" height="28" loading="eager" />
                            <div className="text-left">
